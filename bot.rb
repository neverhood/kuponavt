...
$categories = {
  'Кафе, рестораны' => [ %w(кафе ресторан меню), %w( суши пицца техн+кухн ) ],
  'Бары, клубы, караоке' => [ %w(бар клуб party дискотек вечеринк караоке), %w(стоматолог дайвинг клубни) ],
  'Пицца' => [ %w(пицца) ],
  'Суши' => [ %w(суши ролл) ],
  ...
  'Парикмахерские' => [ %w(волос стрижк укладк ламинирован мелирован каутеризац наращиван завивк выпрямлен окрашиван биозавивк восстановлен+волос наращиван косичк), %w(ресниц мезотерап) ],
  'Солярии' => [ %w(соляр) ],
  'Салоны красоты' => [ %w(маникюр педикюр ногт шугаринг эпиляция наращиван увеличен ревитализац татуаж макияж парафинотерап кожа чистк+лиц кож+лиц пилинг акне кавитац лифтинг чистк+спин), %w(spa целлюлит) ],
  ...
  'Одежда, обувь, аксессуары' => [ %w(сумк час термобель _бель одежд обув ugg timberland угг футболк наряд корсет эро+бель шапк ремн клатч бюстгалтер валенк унты _плать колгот пуховик _мех рубашк костюм кошел купальник носк аксессуар норк+шуб ботинк портмоне кожгалант сапог сапожк куртк), %w(настен+час) ],
  'Украшения' => [ %w(tiffany ювелир бижутер украшен кристалл swarovski) ],
  'Товары для красоты' => [ %w(pupa косметик крем аромат парфюм лак+волос Schwarzkopf _тен _кист _туш maybelline _мыл бритв _дух шампун туалет+вод), %w(чай+аромат пилинг+космет чистка авто+косметика набор+нож набор+карт) ],
  'Товары для дома' => [ %w(матрас мебел стол подставк пуф кресл кресел постельн техн+кухн дом шкаф чашк одеял подушк покрывал воздух жалюз быт+техн будильн ночник диван пластик+окна сервиз термос настен+час), %w(стол+игр) ],
  'Электроника' => [ %w(планшет apple ipod ipad компьют psp дюйм  mp4 плеер наушник навигатор мышк _мыш видеорегистр электрошок touch электрон беспроводн гарнитур wi+fi вертол электротовар iphone телевизор диагонал ноутбук нетбук телефон устройств модем камер), %w(подставк стол) ],
  'Продукты' => [ %w(сладост жвач жеват+рез алкогол коньяк бурбон ферм морковь лук _икр _карто _торт продукты _напит _водк _ча фрукт ягод масл мёд _вод питан бутыл _сок), %w(жвач+рук банк) ],
  ...
  'Все для детей' => [ %w(дед+мороз _дет _ребен коляск _малыш санк ледянк), %w(угг ugg) ],
  ...
  'Другие услуги' => [ %w() ],
  'Для животных' => [ %w(корм собак pedigree) ],
}
...
#offer = Offer.new('жеват какхи фыагшф ргша23а вга рарара рез')
