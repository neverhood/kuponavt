...
$categories = {
  ...
  'Пицца' => [ %w(пицц) ],
  'Суши' => [ %w(суши_ ролл японск+кухн _вкус+_япони), %w(мезороллер магазин япокнск+кухня _ролик пивн+ресторан) ],
  ...
  'Театры, музеи, выставки' => [ %w(лирическ+комед героическ+комед театр мюзикл спектакл _музе выставк хор_), %w(курс актерск+мастерств кино светодиод+шоу занят+театр+студ) ],
