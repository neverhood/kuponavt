...
URL = 'http://discounter.pro/api/kuponator_export'
PROVIDER = Provider.find_by_name('discounter')

log = Logger.new(File.expand_path('../logs/discounter.log', __FILE__))

cities = ["Санкт-Петербург", "Казань", "Москва", "Новосибирск", "Воронеж"]
