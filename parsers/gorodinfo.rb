...
URL = 'http://www.gorodinfo.ru/partnerxmlfeed46649/'
PROVIDER = Provider.find_by_name('gorodinfo')

log = Logger.new(File.expand_path('../logs/gorodinfo.log', __FILE__))
...
log.info("Starting gorodinfo parser: #{Time.now}")
...
log.info("Finished gorodinfo parser. #{saved} offers added. #{Time.now}")
