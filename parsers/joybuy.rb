...
URL = 'http://joybuy.ru/xml'
PROVIDER = Provider.find_by_name('joybuy')

log = Logger.new(File.expand_path('../logs/joybuy.log', __FILE__))
...
log.info("Starting joybuy parser: #{Time.now}")
...
log.info("Finished joybuy parser. #{saved} offers added. #{Time.now}")
