...
URL = 'http://www.myfant.ru/xml/ALL/'
PROVIDER = Provider.find_by_name('myfant')

log = Logger.new(File.expand_path('../logs/myfant.log', __FILE__))
...
log.info("Finished myfant parser. #{saved} offers added. #{Time.now}")
