...
URL = 'http://partner.planet-eds.ru/xml/all/?aid=5530'
PROVIDER = Provider.find_by_name('planet-eds')

log = Logger.new(File.expand_path('../logs/planet_eds.log', __FILE__))

xml_offers = Nokogiri::XML( open URL ).xpath('//offer')
saved = 0

cities = ["Владимир", "Иваново", "Москва", "Рязань", "Санкт-Петербург", "Смоленск"]
